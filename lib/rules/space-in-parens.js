...
module.exports = {
  ...
  create( context ) {
    ...
    function shouldOpenerHaveSpace( left, right ) {
      return !(
        sourceCode.isSpaceBetween( left, right ) ||
      ...
      Program: function checkParenSpaces( node ) {
        ...
        tokens.forEach( ( token, i ) => {
          ...
          if ( singleString ) {
            ...
            if ( sourceCode.isSpaceBetween( token, target ) ) {
          ...
          if ( singleContents && afterOpenException && beforeCloseException ) {
            const openSpace = sourceCode.isSpaceBetween( openParen, afterOpen );

            const closeSpace = sourceCode.isSpaceBetween( beforeClose, closeParen );
          ...
          if ( isOpenException || isCloseException ) {
            ...
            if ( split ) {
              const hasSpace = sourceCode.isSpaceBetween( ...chars );
