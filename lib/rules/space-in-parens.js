...
module.exports = {
  ...
  create( context ) {
    ...
    // is the token a space or template literal
      ...
      Program: function checkParenSpaces( node ) {
        ...
        tokens.forEach( ( token, i ) => {
          ...
          const singleString = (
            singleContents &&
            (
              ( isOpen && isSpace( nextToken ) ) ||
              ( isClose && isSpace( prevToken ) )
            )
          );
          ...
          // then the matching exception character is on a different line
